...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-pixel':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/Vendor_assets');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
				...
				addOffset('cheer');
				addOffset('sad', 20, -118);
				addOffset('danceLeft', 0, -99);
				addOffset('danceRight', 0, -99);
			...
			case 'hank-knife':
				// HANK ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/Hank_Phase2_assets', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'Hank Idle', 24);
				animation.addByPrefix('singUP', 'Hank Up note', 24);
				animation.addByPrefix('singRIGHT', 'Hank right note', 24);
			...
			case 'hank-gun':
				// HANK ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/Hank_Phase3_assets', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'Hank Idle', 24);
				animation.addByPrefix('singUP', 'Hank Up note', 24);
				animation.addByPrefix('singRIGHT', 'Hank right note', 24);
				...
				addOffset("idle", 0, 20);
				addOffset("singUP", 54, 12);
				addOffset("singRIGHT", -100, -16);
